...
class opal_vanguard_loopback(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.msg_print_rx = blocks.message_debug(True)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/tx15/opal-vanguard/ov1_c0_s2m.cf32', False)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.depacketizer, 'out'), (self.msg_print_rx, 'print'))
        ...
        self.msg_connect((self.pdu_strobe, 'strobe'), (self.packetizer, 'in'))
        self.connect((self.blocks_char_to_float_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_waterfall_sink_x_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.rot_rx, 0))
        self.connect((self.gfsk_demod, 0), (self.blocks_char_to_float_0, 0))
        ...
        self.connect((self.rot_rx, 0), (self.blocks_file_sink_0, 0))
